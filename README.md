...
<head>
    ...
    <title>Bruno Erdison - UI/UX Interaction Designer</title>
    ...
    <style>
        body {
            ...
            color: #111827; /* Tailwind gray-900, approximating black */
            background-color: #FFFFFF;
        }
        .text-main { color: #1F2937; } /* gray-800 */
        .text-subtle { color: #4B5563; } /* gray-600 */
        ...
        /* Styling for elements that will be animated, to hide them initially */
...
<body class="overflow-x-hidden">
    ...
    <section id="experience-projects" class="py-16 md:py-24 relative">
        <div class="container mx-auto px-6">
